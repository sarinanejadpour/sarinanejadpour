...
btn4=Button(root,text='+',font=('times new roman',20,'bold'),fg='blue',bg='silver',width=5,height=2,command=lambda:addnum('+'))
...
btn8=Button(root,text='-',font=('times new roman',20,'bold'),fg='blue',bg='silver',width=5,height=2,command=lambda:addnum('-'))
...
btn12=Button(root,text='*',font=('times new roman',20,'bold'),fg='blue',bg='silver',width=5,height=2,command=lambda:addnum('*'))
...
btn16=Button(root,text='/',font=('times new roman',20,'bold'),fg='blue',bg='silver',width=5,height=2,command=lambda:addnum('/'))
